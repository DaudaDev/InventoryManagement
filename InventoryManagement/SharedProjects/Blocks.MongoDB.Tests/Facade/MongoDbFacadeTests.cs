...
public class MongoDbFacadeTests : MongodbFixture
{
    ...
    public async Task GetEntityById_Should_Return_Expected_Document()
    {
        ...
        var result = await sut
            .GetEntityById(TestCollection, _testDocument1.EntityId.ToString());
    ...
    public async Task DeleteEntity_GetCollection_Failes_Return_Error()
    {
        ...
        var result = await sut.DeleteEntity(TestCollection, _testDocument1.EntityId.ToString());
    ...
    public async Task DeleteEntity_Should_Delete_Document()
    {
        ...
        var result = await sut
            .DeleteEntity(TestCollection, _testDocument1.EntityId.ToString());
    ...
    public async Task SaveEntity_Should_Return_Expected_Document()
    {
        ...
        var updatedDocument = await MongoCollection
            .FindAsync(entity => entity.EntityId.Equals(_testDocument1.EntityId));
    ...
    public async Task SaveEntity_Document_Does_Not_Exist_Adds_New_Document()
    {
        ...
        var updatedDocument = await MongoCollection
            .FindAsync(entity => entity.EntityId.Equals(_testDocument3.EntityId));
